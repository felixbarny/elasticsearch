...
public final class IndexingSlowLog implements IndexingOperationListener {
    ...
    static final class IndexingSlowLogMessage {
        ...
        private static Map<String, Object> prepareMap(
            ...
            if (maxSourceCharsToLog == 0 || doc.mainSource() == null || doc.mainSource().length() == 0) {
                return map;
            }
            try {
                String source = XContentHelper.convertToJson(doc.mainSource(), reformat, doc.getXContentType());
