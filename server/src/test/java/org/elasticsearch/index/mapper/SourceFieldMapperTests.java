...
public class SourceFieldMapperTests extends MetadataMapperTestCase {
    ...
    public void testNoFormat() throws Exception {
        ...
        assertThat(XContentHelper.xContentType(doc.mainSource()), equalTo(XContentType.JSON));
        ...
        assertThat(XContentHelper.xContentType(doc.mainSource()), equalTo(XContentType.SMILE));
    }
