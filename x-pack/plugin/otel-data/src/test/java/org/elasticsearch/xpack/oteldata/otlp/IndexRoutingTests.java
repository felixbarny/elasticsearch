...
public class IndexRoutingTests extends ESTestCase {
    ...
    public void testRouteWithExplicitIndex() {
        ...
        IndexRouting index = IndexRouting.route("metrics", attributes, "test.scope", List.of(), List.of());
    ...
    public void testRouteWithScopeAttributes() {
        ...
        IndexRouting index = IndexRouting.route("metrics", List.of(), "test.scope", scopeAttributes, List.of());
    ...
    public void testRouteWithResourceAttributes() {
        ...
        IndexRouting index = IndexRouting.route("metrics", List.of(), "test.scope", List.of(), resourceAttributes);
    ...
    public void testAttributePrecedence() {
        ...
        IndexRouting index = IndexRouting.route("metrics", attributes, "test.scope", scopeAttributes, resourceAttributes);
    ...
    public void testRouteWithReceiverInScopeName() {
        IndexRouting index = IndexRouting.route(
            "metrics",
            List.of(),
    ...
    public void testRouteWithDefaultValues() {
        IndexRouting index = IndexRouting.route("metrics", List.of(), "test.scope", List.of(), List.of());
